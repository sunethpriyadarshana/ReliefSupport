...
public class MainMenuActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewNeedCountChartButton = (CardView) findViewById(R.id.viewNeedCountChartButton);
        ...
        viewHelpCountChartButton = (CardView) findViewById(R.id.viewHelpCountChartButton);
